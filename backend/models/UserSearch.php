...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'phone', 'city', 'address', 'comment', 'admin_comment', 'name', 'password_confirm'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'password_confirm', $this->password_confirm]);
